...
public class MainActivity extends AppCompatActivity {
    ...
    {
        users[0]=new Users("Szymon", "1");
        users[1]=new Users("Szymon", "1");
        for(int i=1; i<10; i++)
            users[i]=new Users();
    }
    ...
    public void logowanie(View view) {
        ...
        Intent intent= new Intent(MainActivity.this, LampkiActivity.class);
        EditText et1, et2;
        TextView co;
        ...
        for(int i=0; i<10; i++) {
            ...
            else if (!log.equals("Szymon") && !pass.equals(""))
                co.setText("Podany użytkownik nie istnieje.");
            else if (!pass.equals("1") && log.equals("Szymon"))
