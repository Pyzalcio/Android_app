...
public class WstepActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_wstep, menu);
        return true;
    }
    ...
    public void przycisk(View view) {
        ...
        {
            case R.id.swiatlo:
                intent = new Intent(WstepActivity.this, SwiatloActivity.class);
                startActivity(intent);
                break;
            case R.id.zaslony:
            ...
            case R.id.went:
                ...
                break;
            case R.id.tryb:
                intent = new Intent(WstepActivity.this, TrybyActivity.class);
                startActivity(intent);
                break;
